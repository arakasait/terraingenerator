...
var templeOfSkulls = new Terrain ("Hill", "Open terrain, +1 to combat resolution for units that charged down the hill that turn.", "Temple of Skulls",'At the beginning of each player turn, any character or champion on the Temple of Skulls can choose to embrace the favour of the Chaos Gods. If he does, roll a D6. On a roll of 2-6, one randomly chosen characteristic increases by D3 points. On a 1, the Chaos Gods htake his soul (or his purehearted comrades turn on im) - remove the model as a casuality with no saves of any kind allowed.', "118", undefined);


//6. BUILDINGS
var building = new Terrain("Building","Building Rules","Building","Multiple","None","118",undefined);

//7. MYSTERIOUS FORESTS
var mysteriousForest = new Terrain ("Forest", "Forest Rules","Mysterious Forest","None","118",undefined);
...
// 9. MYSTERIOUS RIVERS
var mysteriousRiver = new Terrain("River","River Rules","Mysterious River","None","None","118",undefined);
...
function marsh() {
    var marshRoll = (Math.floor((Math.random() * 6)+1));
    console.log(marshRoll);
    var result;
    switch (marshRoll) {
        case 1:
            result = earthbloodMere;
            break;
        case 2:
            result = earthbloodMere;
            break;
        case 3:
            result = khemrianQuicksand;
            break;
        case 4:
            result = khemrianQuicksand;
            break;
        case 5:
            result = mistWreathedSwamp;
            break;
        case 6:
            result = mistWreathedSwamp;
            break;
...
function magicalMystery() {
    ...
    switch (magicalMysteryRoll) {
        case 1:
            result = sinisterStatue;
            break;
        case 2:
            result = arcaneRuins;
            break;
        case 3:
            result = nehekharanSphynx;
            break;
        case 4:
            result = sorcerousPortal;
            break;
        case 5:
            result = wyrdingWell;
            break;
...
function steadfastSanctum() {
    ...
    switch (steadfastSanctumRoll) {
        case 1:
            ...
            break;
        case 2:
            result = acropolisOfHeroes;
            break;
        case 3:
            result = wizardsTower;
            break;
        case 4:
            result = sigmariteShrine;
            break;
        case 5:
            result = elvenWaystone;
            break;
        case 6:
            result = dwarfBrewhouse;
            break;
    }
    return result;
}
...
function obstacles() {
    ...
    switch (obstaclesRoll) {
        ...
        case 2:
            ...
            break;
        case 3:
            result = blazingBarricade;
            break;
        case 4:
            result = blessedBulwark;
            break;
        case 5:
            result = ghostFence;
            break;
...
function insertArray() {
    ...
    for (var d = 0; d < finalTerrain.length; d++)
    {
        ...
        var t = document.createTextNode(dPlusOne + ": "+  finalTerrain[d].subType);      // Create a text node
